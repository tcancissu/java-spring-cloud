...
public class MyFoodRdsStack extends Stack {

    public MyFoodRdsStack(final Construct scope, final String id, final Vpc vpc) {
        this(scope, id, null, vpc);
    }

    public MyFoodRdsStack(final Construct scope, final String id, final StackProps props, final Vpc vpc) {
        super(scope, id, props);

        CfnParameter senha = CfnParameter.Builder.create(this, "senha")
                .type("String")
                .description("Senha do database de pedidos")
                .build();
        ...
        DatabaseInstance database = DatabaseInstance.Builder
                .create(this, "myfood-pedidos")
                .instanceIdentifier("myfood-aws-pedido-db")
